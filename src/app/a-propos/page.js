    ...
    <div>
      <section className="mx-auto grid max-w-6xl items-center gap-12 px-5 py-20 lg:grid-cols-2 lg:px-8">
        <div>
          ...
          <Link href="/comment-ca-marche" className="mt-6 inline-block rounded-full border border-blue/25 px-6 py-3 text-sm font-semibold hover:border-blue-400 hover:text-white-400">
